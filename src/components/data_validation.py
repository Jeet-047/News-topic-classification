...
class DataValidation:
    ...
    def is_column_exist(self, df: DataFrame) -> bool:
        ...
        Description :   This method validates the existence of a numerical and object column
        ...
        try:
            ...
            for column in self._schema_config["object_column"]:
                if column not in dataframe_columns:
            ...
            return False if len(missing_object_columns)>0 or len(missing_numerical_columns)>0 else True
        except Exception as e:
